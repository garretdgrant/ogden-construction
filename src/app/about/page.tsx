          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                ...
                Our portfolio includes custom decks, home additions, guest
                houses, and full new home construction, our team brings decades
                of hands-on experience to every job site.
              </p>
              <p className="text-gray-600 mb-4">
              ...
              <p className="text-gray-600">
                ...
                remain a small, dedicated team with a strong local reputation
                and a passion for helping homeowners bring their vision to
                life—one nail, beam, and board at a time.{" "}
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Fully licensed contractor (CA–1042758) with complete
                    insurance and bonding for peace of mind on every project.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Deeply familiar with the building codes, terrain, and needs
                    of homeowners in El Dorado and Sacramento counties.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    completed with precision, pride, and materials built to
                    last.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Locally owned and operated—supporting youth sports and
                    giving back to the communities we help build.
                  </p>
                </div>
              </div>
              <div className="mt-4">
